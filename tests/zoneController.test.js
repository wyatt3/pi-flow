...
describe('ZoneController', () => {
  ...
  describe('getAll', () => {
    ...
    it('should handle zones that fail to instantiate', () => {
      const mockZones = [
        { id: 1, name: 'Zone A', gpio_pin: 17, active: 0 },
        { id: 2, name: 'Invalid Zone', gpio_pin: 999, active: 0 }, // Invalid pin
      ];
      ...
      // Should return the raw object if Zone instantiation fails
  ...
  describe('create', () => {
    ...
    it('should accept gpio_pin 0', () => {
      // Test edge case where gpio_pin is 0 (falsy but valid)
  ...
  describe('update', () => {
    ...
    it('should convert string active value to number', () => {
      mockReq.params = { id: '1' };
      mockReq.body = { active: '0' }; // String instead of number
      const mockZoneData = { id: 1, name: 'Test Zone', gpio_pin: 17, active: 1 };
      const updatedZone = { ...mockZoneData, active: 0 };
